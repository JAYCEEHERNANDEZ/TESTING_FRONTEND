...
const ResidentLayout = ({ children, notifications, showNotifications, setShowNotifications, handleMarkAsRead }) => {
      ...
      >
       <div className="flex flex-col items-center mt-8 mb-4 px-4">
            ...
            <div className="flex items-center justify-between w-full">
                <h1
                className={`text-2xl font-bold text-blue-600 cursor-pointer ${sidebarOpen ? "" : "mx-auto"}`}
        ...
        <div className="mt-auto mb-4 py-2 px-2 text-center flex flex-col items-center">
          {sidebarOpen && (
            <span className="text-lg font-semibold text-blue-500 uppercase mb-2">SUCOL WATER SYSTEM</span>
